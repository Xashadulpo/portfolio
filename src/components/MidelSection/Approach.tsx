  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 px-10">
        ...
        <h2 className="text-white text-xl opacity-0 text-center group-hover/canvas-card:opacity-100 relative z-10 mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200">
          {title}
        </h2>
        <p
